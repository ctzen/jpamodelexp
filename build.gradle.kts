import com.ctzen.jpamodelexp.gradle.Config
...
object Pub {
    const val name = "jpamodelexp"
    object Github {
        const val repo = "ctzen/jpamodelexp"
...
dependencies {
    ...
    implementation(Config.Deps.libHibernateCore)
    implementation(Config.Deps.libH2)
    ...
    testAnnotationProcessor(Config.Deps.apJpaModelGen)
}
